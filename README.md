...
```bash
npm test           # full suite: 97 assertions (engine, ledger, API, samples, UI)
```
...
- **Testing:** 97 assertions across 6 suites — OCR+mapper, validation engine, ledger lifecycle, API end-to-end, sample narratives, full-stack UI (jsdom)
